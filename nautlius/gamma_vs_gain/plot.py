...
def objective(params, alpha, b, users, AU, AB, H):
    r, cx, cy = params
    return -meanSE(alpha, 
                   r, 
                   cx, 
...
def run_once(D, users):
    ...
    opt_se = meanSE(alpha_opt, r_opt, cx_opt, cy_opt, b_opt, users=users)
    centered_se = meanSE(alpha0, r0, D, cy0, b0, users=users)
